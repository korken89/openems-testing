...
%
substrate.width  = 60;             % width of substrate
substrate.length = 25+10;          % length of substrate
...
ifa.l  = 57;         % length of radiating element
ifa.w1 = 1;            % width of short circuit stub
ifa.w2 = 1;          % width of radiating element
ifa.wf = 1;            % width of feed element
ifa.fp = 3;            % position of feed element relative to short
                       %  circuit stub
...
SimBox = [substrate.width*3 substrate.length*3 150];

%% setup FDTD parameter & excitation function
f0 = 1e9; % center frequency
fc = 7e8; % 20 dB corner frequency
...
tl = [-25,substrate.length/2-ifa.e,substrate.thickness];   % translate
start = [0 0.5 0] + tl;
